...
def boss():
	...
	for i in range(0, 4):
		if i == 0:
			...
			raw_input(a)
			print """
Without his big toe the titan stumbles around allowing you to cut deep into 
his achilles.
"""
			...
			raw_input(a)
			print """
The behemoth falls to the ground and you manage to deliver the final blow to 
...
"""
	...
	print "completed", completion, "% of Titan Slayer."
	print "\nGAME OVER"
	exit(0)
